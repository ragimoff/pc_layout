...
const colorTimerBlock = document.querySelector('.main-display__timer')
...
const numWord = (value, words) => {
	...
	if(lasNum > 1 & value < 5) return words[1]
...
const updateTimer = () => {
	const date = new Date() 
	const dateDeadline = new Date('30 september 2022').getTime()
	...
	if(timeRemaining <= 0) {
		...
		colorTimerBlock.style.color = 'red'
	}
}
